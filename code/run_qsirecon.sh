...
for sub in ${myArray[@]}; do
	dwi=${maindir}/derivatives/qsirecon-noddi/qsirecon-NODDI/${sub}/dwi/${sub}_space-T1w_desc-preproc_model-noddi_mdp-od_dwimap.nii.gz
	html=${maindir}/derivatives/qsirecon-noddi/qsirecon/${sub}.html
